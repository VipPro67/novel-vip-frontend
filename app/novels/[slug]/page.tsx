...
export default function NovelDetailPage() {
  ...
  const [chaptersSize, setChaptersSize] = useState(20);
  ...
  const startReading = () => {
    if (chapters.length > 0) {
      ...
      router.push(
        `/novels/${targetSlug}/chapters/${chapters[0].chapterNumber}`
      );
    }
  };
            ...
            <div className="space-y-6">
              ...
              >
                <TabsList className="grid w-full grid-cols-2">
                  ...
                  <TabsTrigger
                    value="comments"
                    onClick={() => !commentsLoaded && fetchNovelComments()}
                  >
                    Comments
                  </TabsTrigger>
                </TabsList>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                            <span>
                              Showing page {chaptersPage + 1} of{" "}
                              {Math.max(1, chaptersTotalPages)}
                            </span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <select
                                ...
                                <div className="flex justify-between items-center">
                                  <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                      Updated{" "}
                                      {formatRelativeDate(chapter.updatedAt)}
                                    </p>
                                  </div>
                                </div>
                              </Link>
                        ...
                        <div className="flex items-center justify-between border-t pt-4">
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              setChaptersPage((p) => Math.max(0, p - 1))
                            }
                          ...
                          <div className="flex items-center gap-1 text-sm">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                setChaptersPage(
                                  Math.max(0, chaptersTotalPages - 1)
                                )
                              }
                          ...
                          <Button
                            ...
                            onClick={() =>
                              setChaptersPage((p) =>
                                Math.min(chaptersTotalPages - 1, p + 1)
                              )
                            }
                            disabled={
                              chaptersPage >= chaptersTotalPages - 1 ||
                              chaptersLoading
                            }
                          >
                            Next
