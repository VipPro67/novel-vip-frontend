...
const filterKeys: FilterKey[] = ["keyword", "title", "author", "category", "genre", "tag"]
...
export default function SearchPage() {
    ...
    const updateURL = useCallback((filters: SearchFilters, page: number, sort: { sortBy: string; sortDir: string }) => {
    ...
    useEffect(() => {
        const fetchTaxonomies = async () => {
            try {
                const [categoryResponse, genreResponse, tagResponse] = await Promise.all([
                    api.getCategories(),
                    api.getGenres(),
                    api.getTags(),
                ])
